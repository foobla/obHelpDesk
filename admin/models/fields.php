 ...
 */
class obHelpDeskModelFields extends JModelList
{
	/**
	 * Constructor.
	 */
	...
	protected function getListQuery()
	{
		...
		$query->from($db->quoteName('#__obhelpdesk3_fields').' AS a');
		...
		if ($this->getState('filter.search') !== '')
		{
			...
			$searches[]	= 'a.helptext LIKE '.$token;
			$searches[]	= 'a.type LIKE '.$token;
