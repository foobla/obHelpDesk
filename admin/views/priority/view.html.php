...
/**
 * View to edit a priority
 */
class obHelpDeskViewPriority extends obView
{
	protected $form;
	protected $item;
	protected $state;
	...
	protected function addToolbar()
	{
		...
		JToolBarHelper::title(JText::_($isNew ? 'OBHELPDESK_PRIORITY_ADD_NEW' : 'OBHELPDESK_PRIORITY_EDIT'), 'priority');
		...
		if (empty($this->item->id))  {
			...
			JToolBarHelper::cancel('priority.cancel', 'JTOOLBAR_CLOSE');
		}
	}
}
