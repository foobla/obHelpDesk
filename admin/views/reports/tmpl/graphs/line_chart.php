<?php
/**
* @package		$Id: line_chart.php 2 2013-07-30 08:16:00Z thongta $
* @author 		foobla.com
...
class SA_LineChart implements SA_Chart {
	...
	function __construct($_data, $_columns, $_dataHolder, $_graphContainer, $_from, $_to, $_unit) {
		$this->data = $_data;
