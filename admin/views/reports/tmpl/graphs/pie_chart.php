<?php
/**
* @package		$Id: pie_chart.php 2 2013-07-30 08:16:00Z thongta $
* @author 		foobla.com
...
class SA_PieChart implements SA_Chart {

	var $package = 'corechart';
	...
	function __construct($_data, $_columns, $_dataHolder = 'gdata', $_graphContainer = 'chart_div') {
		$this->data = $_data;
		...
		foreach ($this->data as $sa_record) {
			...
			foreach($sa_record_fields as $sa_field_name => $sa_field_value) {
				...
				if($field_counter ==0){
					...
					$report_output .= $this->dataHolder . ".setCell(" . $record_counter . ", " . "1" . ", " . $sa_field_value . ", '" . $formatted_value . "');\n";
	...
	public  function loadGraphData_1()
	{
		...
		{
			$report_output .= $this->dataHolder . ".setCell(" . $i . ", " . "0" . ", '" . $list_data_date2[$i] . "');\n";
			$report_output .= $this->dataHolder . ".setCell(" . $i . ", " . "1" . ", " . $list_data_value2[$i] . ", '" .  $list_data_value2[$i] . "');\n";
		}
